...
local D_URL = "https://raw.githubusercontent.com/zenyuukito/Yuukiware/refs/heads/main/Main/Functions/Dragging.lua"
local ICON = "rbxthumb://type=Asset&id=111918789930704&w=420&h=420"
local BaseURL = "https://raw.githubusercontent.com/zenyuukito/Yuukiware/main/Main/Tabs/"
...
-- THE ONLY LINE YOU EVER NEED TO EDIT IS THIS ONE:
...
for i, v in ipairs(Tabs) do
    ...
    -- AUTO-LOADER: Grabs the file from GitHub and gives it the Page (S)
    task.spawn(function()
        local s, func = pcall(function() return loadstring(game:HttpGet(BaseURL .. v .. ".lua"))() end)
        if s and type(func) == "function" then func(S) end
    end)

    -- Tab Click Animation & Switching
